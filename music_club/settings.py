...
# Base URL used when building absolute links that must work from any device
# (for example, email verification links). Set this to your public domain or
# LAN URL, e.g. 'http://192.168.1.10:8000' or 'https://myshop.com'.
